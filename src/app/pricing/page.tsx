...
import ProPlanView from "../../components/pricing/ProPlanView";
import NavigationHeader from "@/components/NavigationHeader";
import { ENTERPRISE_FEATURES, FEATURES } from "../../constants/pricing";
import { Star } from "lucide-react";
import FeatureCategory from "../../components/pricing/FeatureCategory";
...
async function PricingPage() {
  ...
  {/* Original price */}
  <div className="text-xl font-medium text-red-400/70 line-through">
    ₹49
  </div>
  ...
  <div className="flex items-baseline gap-1">
    ...
    <span className="text-6xl font-extrabold bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 text-transparent bg-clip-text drop-shadow-lg">
      29
    </span>
    <span className="text-xl text-pink-200">one-time</span>
  </div>

  {/* Discount badge */}
  <span className="px-3 py-1 rounded-full text-sm font-semibold bg-gradient-to-r from-green-400 to-green-600 text-white shadow-lg shadow-green-500/30">
    Save 40%
  </span>
</div>
